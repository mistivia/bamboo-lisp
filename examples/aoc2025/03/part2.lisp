...
;;;
;;; Each line is a row of digits. Take twelve of them, keeping their order, to
;;; get the largest possible twelve digit number; sum that over all lines.
;;;
