...
function findWasmBinary() {
    return locateFile('web-bamboo-lisp.wasm');
}
...
var _lisp_to_string = Module['_lisp_to_string'] = makeInvalidEarlyAccess('_lisp_to_string');
...
function assignWasmExports(wasmExports) {
  Module['_lisp_to_string'] = _lisp_to_string = createExportWrapper('lisp_to_string', 2);
